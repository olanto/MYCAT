 ...
 */
public class ConfigurationNative implements IdxInit {

    /** cr̩e l'attache de cette classe.
     */
    public ConfigurationNative() {
    }
    ...
    public void InitConfiguration() {
        ...
        // les directoire
        String root = "c:/JG/VLI_RW/data/test";
        String root0 = "c:/JG/VLI_RW/data/test0";
        String root1 = "c:/JG/VLI_RW/data/test1";
        String root2 = "c:/JG/VLI_RW/data/test2";
        String root3 = "c:/JG/VLI_RW/data/test3";
//        String root = "f:/test";
//        String root0 = "f:/test0";
//        String root1 = "f:/test1";
//        String root2 = "f:/test2";
//        String root3 = "f:/test3";
        COMMON_ROOT = root;
        DOC_ROOT = root;
        WORD_ROOT = root;
