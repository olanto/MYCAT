...
public class ConfigurationIndexingGetFromFile implements IdxInit {
    ...
    public void InitConfiguration() {
        ...
        MODE_RANKING = RankingMode.valueOf(prop.getProperty("MODE_RANKING", "BM25"));
        ...
        ORIGINAL_HOST = prop.getProperty("ORIGINAL_HOST");
        ORIGINAL_PORT = prop.getProperty("ORIGINAL_PORT");
