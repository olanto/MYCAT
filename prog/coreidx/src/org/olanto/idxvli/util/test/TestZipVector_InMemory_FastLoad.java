...
public class TestZipVector_InMemory_FastLoad {
    ...
    public static void main(String[] args) {
        ...
        /*     o = (new ZipVector_InMemory_FastLoad()).create("C:/MYCAT/TEMP", "zipvect", 20);
         o = (new ZipVector_InMemory_FastLoad()).open("C:/MYCAT/TEMP", "zipvect", readWriteMode.rw);
         o.set(0, s0);
        ...
        o = (new ZipVector_InMemory_FastLoad()).create("C:/MYCAT/TEMP", "zipvect", 23);
        o = (new ZipVector_InMemory_FastLoad()).open("C:/MYCAT/TEMP", "zipvect", readWriteMode.rw);
