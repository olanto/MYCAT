 ...
 *
 *
 * Comportements d'un gestionaire de mots. les mots sont ajoutés
 * séquentiellement par rapport au id retourné
 *
 * <P>
 * exemple de code pour un test d'une implémentation de l'interface.
 *
 * <pre>
...
public interface StringRepository {
    ...
    /**
     * crée une word table de la taille 2^_maxSize par défaut à l'endroit
     * indiqué par le path, (maximum=2^31), avec des string de longueur max
     * _lengthStrin
     *
     * @param _path
     * @param _lengthString
    ...
    /**
     * cherche le numéro du terme, retourne EMPTY s'il n'est pas dans le
     * dictionnaire
     *
     * @param w
     * @return
    ...
    /**
     * cherche le terme associé à un numéro, retourne NOTINTHIS s'il n'est pas
    ...
    /**
     * modifier la valeur du string, (sttention!) utilisé pour invalider une
