 ...
 */
public class ContentIndexingWithoutServer_EUBOOK_FREN {      // is an application, not an applet !
 ...
 IndexingMosesCorpus.indexThis(id, "C1", "C:/CORPUS/EUBOOK/SMT/FREN/corpus.so", "C:/CORPUS/EUBOOK/SMT/FREN/corpus.ta", "FR", "EN", Integer.MAX_VALUE, "UTF-8");
