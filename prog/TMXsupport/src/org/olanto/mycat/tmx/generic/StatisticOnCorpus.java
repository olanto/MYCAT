 ...
 */
public class StatisticOnCorpus {      // is an application, not an applet !

    static Timer t1 = new Timer("global time");

    public static void main(String[] args) {

        indexThis("C1", "C:/CORPUS/DGT2014/DGT2014.24x", Integer.MAX_VALUE, "UTF-8");

    }

    public static void indexThis(String name, String fileso, int limit, String txt_encoding) {
        int[] stat = new int[24];
