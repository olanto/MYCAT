...
public class RunIndexingServer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            IndexService_MyCat idxsrv = GetIndexService.runServiceIDX(new ConfigurationIndexingGetFromFile(SenseOS.getMYCAT_HOME("NGRAM")+"/config/IDX_fix.xml"), "rmi://localhost/NGRAM");
