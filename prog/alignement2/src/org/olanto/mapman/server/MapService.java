...
/**
 * Facade pour les services des contents manager en modeRMI (ces services
 * peuvent être augmentés en publiant des méthodes de MapArchiveStructure)
 *
 */
public interface MapService extends Remote {
    ...
    /**
     * Pour obtenir le nom des Glossaries du mappeur
     *
     * @return GLOSS_NAME
     * @throws java.rmi.RemoteException
     */
