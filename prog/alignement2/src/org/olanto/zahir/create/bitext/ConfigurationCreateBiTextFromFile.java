 ...
 */
public class ConfigurationCreateBiTextFromFile implements CreateBiTextInit {
     ...
     */
    public ConfigurationCreateBiTextFromFile() {
    }
     ...
     */
    public ConfigurationCreateBiTextFromFile(String fileName) {
    ...
    public void InitConfiguration() {
        ...
        FOLDER_BITEXT = prop.getProperty("FOLDER_BITEXT", SenseOS.getMYPREP_HOME() + "/BITEXT");
