...
public class TESTQL_CLASSIC {
    ...
    public static void main(String[] args) {
        ...
        id = new IdxStructure("INCREMENTAL", new ConfigurationForKNN());
        id.Statistic.global();
        msg("1000:" + id.getStringforW(1000));
        msg("lenght:" + id.getOccOfW(1000));
        //id.checkIntegrityOfW("larger",true);
        //testref();


        test("telecommunications company");
//        test("hashtable");
