...
//        System.out.println(id.getDoc(419566));
//        System.out.println(id.getDoc(419566));
   ...
   //     KNN = new TFxIDF();
        KNN.initialize(id, // Indexeur
                ...
                1, // Max en o/oo d'apparition dans le corpus (par mille!)
        ...
        t2.stop();
        int ntop = 20;
 //       test1("telecommunications company",10);
        //419567
        test2("Utricularia microcalyx	 Utricularia microcalyx is a small to medium-sized annual carnivorous plant that belongs to the genus Utricularia. It is native to tropical Africa where it can be found in the Democratic Republic of the Congo and Zambia. U. microcalyx grows as a terrestrial plant in damp sandy or peaty soils in grasslands at altitudes from 1200 m (3937 ft) to 1650 m (5413 ft). It typically flowers between February and July."
                ,ntop);
//        test2("Utricularia microcalyx	 Utricularia microcalyx is a small to medium-sized annual carnivorous plant that belongs to the genus Utricularia. It is native to tropical Africa where it can be found in the Democratic Republic of the Congo and Zambia. U. microcalyx grows as a terrestrial plant in damp sandy or peaty soils in grasslands at altitudes from 1200 m (3937 ft) to 1650 m (5413 ft). It typically flowers between February and July."
//                ,ntop);
       //407648

//        test2("Maytenus clarendonensis	 Maytenus clarendonensis is a species of plant in the Celastraceae family. It is endemic to Jamaica."
//                ,ntop);
        System.out.println(id.getIntForW("plant"));
...
//        showSIM(sim, 0.002f);
      ...
      private static void test2(String s, int nTop) {
        TimerNano t1 = new TimerNano("KNN: " + s + " " + nTop, false);

         KNN.showKNNWithContent(KNN.getKNN(s, nTop));
        t1.stop(false);
    }
