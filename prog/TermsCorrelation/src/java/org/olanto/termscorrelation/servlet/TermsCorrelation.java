 ...
 * @author simple
 */
@WebServlet(name = "TermsCorrelation", urlPatterns = {"/termscorrelation"})
public class TermsCorrelation extends HttpServlet {

     public static void main(String[] args) {  //only to debug
NgramAndCorrelation.initIS();
        ServletProcess.init();
        String s = ServletProcess.getQueryForm("pomme de terre", "FR","potatoes", "EN");
              FormatHtmlTermsCorrelation formatter = new FormatHtmlTermsCorrelation();
        s+=formatter.getHtmlResult("pomme de terre", "FR","potatoes", "EN");
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ServletProcess.init();
        ServletProcess.processQery(request, response);
    }
