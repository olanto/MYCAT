...
public class RefStatistic {
    ...
    public String getHeaderSat(String fileName, int minlen, int minocc) {
        ...
        res.append("</p>");
        res.append("</p>");
        res.append("</p>" + MySelfQuoteDetection.MsgManager.get("server.qd.MSG_1") + " " + fileName);
        res.append("</p>" + MySelfQuoteDetection.MsgManager.get("server.qd.MSG_3") + " " + alldoc.length);
        res.append("</p>" + MySelfQuoteDetection.MsgManager.get("server.qd.MSG_5") + " " + minlen);
        res.append("</p>" + MySelfQuoteDetection.MsgManager.get("server.qd.MSG_20") + " " + minocc);
        res.append("</p>");
        return res.toString();
    }
    ...
    public String getStatByRef(String fileName, int minlen, int minocc) {
        ...
        res.append("<caption><b>" + MySelfQuoteDetection.MsgManager.get("server.qd.MSG_21") + "</b></caption>\n"); // titre
        res.append("<tr>\n" //entête
                + "<th>#</th>\n"
                + "<th>" + MySelfQuoteDetection.MsgManager.get("server.qd.MSG_10") + "</th>\n"
                + "<th>" + MySelfQuoteDetection.MsgManager.get("server.qd.MSG_11") + "</br>" + MySelfQuoteDetection.MsgManager.get("server.qd.MSG_12") + "</th>\n"
                + "<th>" + MySelfQuoteDetection.MsgManager.get("server.qd.MSG_22") + "</th>\n"
                + "</tr>\n");
