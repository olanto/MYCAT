 ...
 */
public class QuoteWidgetCall extends Composite {
    ...
    private TextBox fileNameBox = new TextBox();
        ...
        public void onFinish(IUploader uploader) {
            if (uploader.getStatus() == Status.SUCCESS) {
                ...
                if (fileName == null) {
                    ...
                    fileNameBox.setTitle(GuiMessageConst.MSG_42 + fileName);
                    fileNameBox.setText(fileName);
