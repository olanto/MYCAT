...
//            System.out.println("File size: " + read);
    ...
    public static String file2zip(File[] fileNames, String zipFilePath, String fileName) {
        try {
            ZipOutputStream out = new ZipOutputStream(new BufferedOutputStream(new FileOutputStream(zipFilePath)));
            for (int i = 0; i < fileNames.length; i++) {
//                System.out.println(fileNames[i].getName()+" --- " +fileName);
                if (fileNames[i].getAbsolutePath().contains(fileName)) {
