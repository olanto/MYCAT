...
set DIST=C:\JG\prog\SimpleConverter\dist
set LIB=%DIST%\lib
...
"%JRE_HOME%"\bin\java.exe -Xmx512m -cp "%CLASSPATH%" com.simple.converter.SimpleConverterApplicationTest -f txt -b C:/MYCAT/corpus/bad C:/MYCAT/corpus/docs C:/MYCAT/corpus/source
